...
describe('phase0 workspace-mcp fixture', () => {
  it('builds inventory from shared descriptors and binds MCP tools without Convex implementation imports', async () => {
    ...
    expect(operationRefsSource).toContain('projectsCreateExecuteRef')
    expect(operationRefsSource).toContain('projectsDeleteExecuteRef')
    expect(operationRefsSource).toContain('projectsDeletePreviewRef')
    ...
    expect(operationHandlesSource).toContain('executeRef: projectsDeleteExecuteRef')
    expect(operationHandlesSource).toContain('previewRef: projectsDeletePreviewRef')
