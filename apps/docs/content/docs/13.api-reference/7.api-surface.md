...
| Escape hatches                | `unsafe`, `publicWrite`, `crossTenant`, `actingFor`, raw `auth: 'none'`, public table reads                                                            | A reviewed exception is narrower and better proven than the normal lane.            |
